...
| <a name="input_enable_network_policies"></a> [enable\_network\_policies](#input\_enable\_network\_policies) | Determines whether to use network policies | `bool` | `false` | no |
