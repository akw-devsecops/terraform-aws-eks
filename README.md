...
| <a name="input_application_management_cluster_name"></a> [application\_management\_cluster\_name](#input\_application\_management\_cluster\_name) | The name of the application management cluster | `string` | `null` | no |
...
| <a name="input_cluster_management_cluster_name"></a> [cluster\_management\_cluster\_name](#input\_cluster\_management\_cluster\_name) | The name of the cluster management cluster | `string` | `null` | no |
